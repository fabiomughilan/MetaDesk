# MetaDesk ![License](https://img.shields.io/badge/license-MIT-blue) ![PRs Welcome](https://img.shields.io/badge/PRs-welcome-green.svg)
...
```bash
git clone https://github.com/kevinshen56714/MetaDesk.git
```

This will create a folder named `MetaDesk`. You can specify a different folder name like this:

```bash
git clone https://github.com/kevinshen56714/MetaDesk.git my-folder-name
```

To start a server, go into the project folder and install dependencies/run start command:

```bash
cd MetaDesk or 'my-folder-name'
yarn && yarn start
```
...
```bash
cd MetaDesk/client or 'my-folder-name/client'
yarn && yarn dev
```
...
If you're using MetaDesk to power your virtual office or using our code in other projects, please consider [buy me a coffee](https://www.buymeacoffee.com/MetaDesk). Thank you :)
